...
export class RepresentativeController {
    ...
    @ApiOperation({ summary: 'Get all Representatives', operationId: 'GetRepresentatives' })
    @ApiResponse({ status: 200, type: RepresentativeDto })
    @Get()
    ...
    @ApiOperation({ summary: 'Get Representatives by id', operationId: 'GetRepresentatives' })
    @ApiResponse({ status: 200, type: RepresentativeDto })
    @Get(':representative_id')
    async findOne(@Param('representative_id') id: number): Promise<RepresentativeDto> {
    ...
    async update(@Param('representative_id') id: number, @Body() job: RepresentativeDto) {
