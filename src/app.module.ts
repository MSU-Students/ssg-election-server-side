...
@Module({
  imports: [
    TypeOrmModule.forFeature([UserDto, VoterDto, RepresentativeDto, AdminDto, PrimeMinisterDto, AccountTypeDto]),
    TypeOrmModule.forRoot({
      ...
      password: 'root',
      database: 'ssgdb',
      entities: [UserDto, VoterDto, RepresentativeDto, AdminDto, PrimeMinisterDto, AccountTypeDto],
      synchronize: true,
      dropSchema: true,
    }),
  ],
